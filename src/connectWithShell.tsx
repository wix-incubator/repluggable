...
type Returns<T> = () => T;
type MapStateToProps<S, OP, SP> = Maybe<
  (shell: Shell, state: S, ownProps?: OP) => SP
>;
type MapDispatchToProps<OP, DP> = Maybe<
  (shell: Shell, dispatch: Dispatch<Action>, ownProps?: OP) => DP
>;
...
function wrapWithShellContext<S, OP, SP, DP>(
  ...
  class ConnectedComponent extends React.Component<WrappedComponentOwnProps<OP>>
    ...
    constructor(props: WrappedComponentOwnProps<OP>) {
      ...
      this.mapStateToProps = mapStateToProps
        ? (__, ownProps?) =>
            mapStateToProps(
              this.props.shell,
              this.props.shell.getStore<S>().getState(),
              ownProps,
            )
