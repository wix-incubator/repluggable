...
import { AppHost, ExtensionItem, ExtensionSlot, PrivateFeatureHost, ReactComponentContributor } from './api'
...
const PredicateHoc: React.FunctionComponent<PredicateHocProps> = props => <>{props.predicateResult ? props.render() : null}</>
