...
Repluggable uses these awesome languages, libraries, and tools:

- [TypeScript](https://github.com/Microsoft/TypeScript) - [license](https://github.com/microsoft/TypeScript/blob/master/LICENSE.txt)
- [lodash](https://github.com/lodash/lodash) - [license](https://github.com/lodash/lodash/blob/master/LICENSE)
- [React](https://github.com/facebook/react) - [license](https://github.com/facebook/react/blob/master/LICENSE)
...
- [tslint](https://github.com/palantir/tslint) - [license](https://github.com/palantir/tslint/blob/master/LICENSE)
